...
|      |      |      |      |      |      |      |            |      |      |      |      |      |      |      |
| SHFT |  Z   |  X   |  ,   |  Y   |  Ö   | GUI  |            | GUI  |  P   |  D   |  W   |  M   |  K   |  -   |
...
L_SHIFT,    DE_Z,       DE_X,       DE_COMM,    DE_Y,       DE_ODIA,    L_GUI,                  L_GUI,      DE_P,       DE_D,       DE_W,       DE_M,       DE_K,       DE_MINS, \
                                        L_CTRL,     TAB_CTL,    L_SHIFT,    NUM_L,          SYM_L,      KC_SPC,     KC_ENT,     R_CTRL                                           ),
/* layer 1: qwertz
 _________________________________________                            _________________________________________
|      |      |      |      |      |      |                          |      |      |      |      |      |      |
...
L_SHIFT,    DE_Y,       DE_X,       DE_C,       DE_V,       DE_B,       L_GUI,                  L_GUI,      DE_N,       DE_M,       DE_COMM,    DE_DOT,     DE_MINS,    DE_SS,   \
                                        L_CTRL,     TAB_CTL,    L_SHIFT,    NUM_L,          SYM_L,      KC_SPC,     KC_ENT,     R_CTRL                                           ),
