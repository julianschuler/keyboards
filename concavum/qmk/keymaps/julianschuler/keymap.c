...
const uint16_t PROGMEM keymaps[][ROWS + 1][MATRIX_COLS] = {
/* layer 0: vou
 * ┌───┬───┬───┬───┬───┬───┐               ┌───┬───┬───┬───┬───┬───┐
...
SS_ALT,     DE_Z,       DE_X,       DE_COMM,    DE_Y,       DE_ODIA,                        DE_P,       DE_D,       DE_W,       DE_M,       DE_K,       DE_MINS,
...
QK_BOOT,    KC_PSCR,    KC_MUTE,    KC_VOLD,    KC_VOLU,    KC_BRID,                        GUI_F7,     GUI_F8,     GUI_F9,     GUI_F10,    GUI_F11,    GUI_F12,
                                        VOU,        XXXXXXX,    FN_L,                   FN_L,       XXXXXXX,    QWERTZ
),
};
